    ...
    <>
      <section className="home-hero">
        <div className="home-hero-copy">
          <p className="home-kicker">A financial life simulation</p>
        ...
        <aside className="home-scope">
          ...
          <div className="home-scope-facts">
            <span>Runtime</span>
      ...
      >
        ...
        <div className="home-capability-grid">
          {CAPABILITIES.map((capability) => (
            <article className="home-capability-card" key={capability.label}>
