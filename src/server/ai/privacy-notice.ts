...
export const AI_PRIVACY_NOTICE = Object.freeze({
  ...
  summary:
    "Life Finance sends minimized, redacted simulation context to the configured AI provider—OpenAI GPT-5.6, Groq-hosted gpt-oss-120b, or local gpt-oss—to generate adversarial events, onboarding extraction, explanations, character reactions, and educational debriefs. AI never owns financial calculations or directly changes game state.",
  disclosures: Object.freeze([
    ...
    "AI prompts and outputs are encrypted with AES-256-GCM and retained indefinitely for administrator-only auditing. Onboarding is privacy-minimized further: raw free text and provider excerpts are discarded, while only hashes, lengths, counts, and attempt metadata are retained indefinitely.",
