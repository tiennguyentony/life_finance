export const AI_PRIVACY_NOTICE_VERSION = 1 as const;

export const AI_PRIVACY_NOTICE = Object.freeze({
  version: AI_PRIVACY_NOTICE_VERSION,
  title: "How Life Finance uses AI data",
  summary:
    "Life Finance sends minimized, redacted simulation context to OpenAI GPT-5.6 to generate adversarial events, onboarding extraction, explanations, and educational debriefs. GPT never owns financial calculations or directly changes game state.",
