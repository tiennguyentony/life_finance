...
const templates: readonly PersonalEventTemplateV2[] = [
  ...
  },
  {
    ...
    hazard: {
      baseChancePpm: 65_000,
      minimumChancePpm: 65_000,
      maximumChancePpm: 65_000,
      modifiers: [],
    },
    severityTier: "medium",
    pressureCost: 2,
  ...
  },
  {
    ...
    eligibility: [],
    hazard: {
      baseChancePpm: 55_000,
      minimumChancePpm: 55_000,
      maximumChancePpm: 55_000,
      modifiers: [],
    },
    severityTier: "medium",
    pressureCost: 2,
  ...
  },
  {
    ...
    eligibility: [{ type: "employment_status", statuses: ["employed"] }],
    hazard: {
      baseChancePpm: 45_000,
      minimumChancePpm: 45_000,
    ...
    responses: [
      ...
      },
      {
        ...
        label: "Spread the gap over three months",
        requiresMitigationIds: [],
        effects: [{
          type: "recurring_expense",
          magnitude: parameter("cash_flow_gap_cents", 400_000),
          durationMonths: 3,
        }],
      },
      {
